...
const initialData = {
  ...
  products: [
    ...
    {
      id: "prod-211",
      name: "قاعدة مرحاض روزيتا كومبي ساني بيور (SANIPURE)",
      code: "C-1-SNPU-RSTA",
      category: "أطقم حمامات وخلاطات",
      subcategory: "أطقم حمامات كاملة",
      brand: "SANIPURE",
      price: 6251,
      originalPrice: 6650,
      priceUnit: "طقم كامل",
      boxCoverage: 1.00,
      dimensions: "قياسي معلق",
      finish: "بورسلين ناصع التلميع",
      grade: "فرز أول ممتاز",
      origin: "SANIPURE إيطاليا / مصر",
      ...
      variants: [
        {
          id: "v-1",
          color: "أبيض",
          coverType: "غطاء ذاتي الغلق (سوفت كلوز)",
          price: 6251,
          originalPrice: 6650,
          code: "C-1-SNPU-RSTA-W-SC"
        },
        {
          id: "v-2",
          color: "برجامون - بيج فاتح",
          coverType: "غطاء ذاتي الغلق (سوفت كلوز)",
          price: 6800,
          originalPrice: 7250,
          code: "C-1-SNPU-RSTA-P-SC"
        },
        {
          id: "v-3",
          color: "أبيض",
          ...
          price: 5900,
          originalPrice: 6300,
          code: "C-1-SNPU-RSTA-W-STD"
        }
      ],
      description: "طقم قاعدة مرحاض كومبي معلق مع خزان ومشتملات سانيبور SANIPURE الممتازة مع خيارات الألوان والأغطية.",
      image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=1000&q=80"
    },
    {
      id: "prod-t-001",
