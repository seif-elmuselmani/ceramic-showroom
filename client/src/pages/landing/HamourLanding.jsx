...
const HamourLanding = ({ settings, onNavigate }) => {
  ...
  const hamourProducts = [
    {
      title: 'بورسلين اردني 60*120',
      desc: 'بورسلين عالي الجودة يتحمل ضغط المحيط ومناسب جداً للمساحات الكبيرة في قاع الهامور.',
      price: 'عرض حصري',
      img: '/hamour_prod_1.jpg'
    },
    {
      title: 'وحدة حمام بروديوم',
      desc: 'وحده حمام بروديوم ضد المياه علشان متبوظش مننا ف القاع، عملية وشياكة.',
      price: 'عرض حصري',
      img: '/hamour_prod_2.jpg'
    },
    {
